 ...
 * its own sender validation, permission check, and tab-complete logic. Subcommands are registered
 * into their parent via {@link io.github.trae.velocity.framework.command.interfaces.IBaseCommand#$addSubCommand}.</p>
 *
